        ...
        <div className="papers_container">
          <div className="paperwrap">
            ...
            <div className="content_boX">
              ...
              <p>
                This privacy notice for VERGE TECHNOLOGIES SINGLE MEMBER P.C.
                (doing business as Verge Tech) (&apos;<strong>we</strong>&apos;,
              ...
              <ol>
                <li>
                  ...
                  <a href="https://www.verge.app">https://www.verge.app</a>, or
                  any website of ours that links to this privacy notice
                </li>
                <li>
                  Download and use our mobile application (Verge), or any other
              ...
              <p>
                ...
                concerns, please contact us at contact@verge.app.
              </p>
            </div>
            <div className="rules">
              ...
              <p>
                ...
                <a href="#table_of_content">table of contents</a> below to find
              ...
              <p>
                ...
                so. Learn more about{" "}
                <a href="#processYourInfo">how we process your information.</a>
              </p>
              <p>
                <strong>
              ...
              <p>
                ...
                Learn more about{" "}
                <a href="#keepInfo">how we keep your information safe.</a>
              </p>
              <p>
                ...
                Learn more about{" "}
                <a href="#priveryRights"> your privacy rights.</a>
              </p>
              <p>
              ...
              <ol>
                <li>
                  <a href="#collectInfoDone">WHAT INFORMATION DO WE COLLECT?</a>
                </li>
                <li>
                  <a href="#processYourInfo">
                ...
                <li>
                  <a href="#handleSocialLogin">
                    HOW DO WE HANDLE YOUR SOCIAL LOGINS?
                  </a>
                </li>
                <li>
                  <a href="#howLogKeepInfo">
                    HOW LONG DO WE KEEP YOUR INFORMATION?
                  </a>
                </li>
                <li>
                  <a href="#keepInfo">HOW DO WE KEEP YOUR INFORMATION SAFE?</a>
                </li>
                <li>
                  <a href="#collectInfo">
                ...
                <li>
                  <a href="#priveryRights">WHAT ARE YOUR PRIVACY RIGHTS?</a>
                </li>
                <li>
                  <a href="#feature_control">
                    CONTROLS FOR DO-NOT-TRACK FEATURES
                  </a>
                </li>
                <li>
                  <a href="#updateNotice">DO WE MAKE UPDATES TO THIS NOTICE?</a>
                </li>
                <li>
                  <a href="#contactUSNotice">
              ...
              <h3 id="collectInfoDone">1. WHAT INFORMATION DO WE COLLECT?</h3>
              ...
              <p className="stripe_link">
                ...
                payment instrument. All payment data is stored by Stripe, Apple
                and Google. You may find their privacy notice link(s) here:{" "}
                <a
                  target="_blank"
                  href="https://stripe.com/en-gr/privacy, https://www.apple.com/legal/privacy/data/en/app-store/ and https://play.google.com/about/play-terms/"
                >
                  https://stripe.com/en-gr/privacy,
                  https://www.apple.com/legal/privacy/data/en/app-store/ and
              ...
              <ul>
                ...
                <li>
                  ...
                  mobile device&apos;s camera, microphone, storage, social media
                  accounts, notifications, and other features. If you wish to
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ol>
                      ...
                      <li>
                        Diagnoseproblems and/or prevent fraudulent activities
                      </li>
                      <li>
              ...
              <span>
                ...
                information with any organisation apart from us. They also
              ...
              <ul>
                ...
                <li>
                  ...
                  APIs (e.g. Google Maps API, Places API). We obtain and store
                  on your device (&apos;cache&apos;) your location. You may
                ...
                <li>
                  ...
                  affiliates to honour this privacy notice. Affiliates include
                ...
                <li>
                  ...
                  may appear in our application(s) and be displayed to you based
                  ...
                  will leave our application(s). A unique identifier, such as
                  your user ID, will be shared with the offer wall provider in
                  order to prevent fraud and properly credit your account with
                  the relevant reward.
                </li>
              </ul>
              <h3 id="thirdPart">
              ...
              <h3 id="keepInfo">9. HOW DO WE KEEP YOUR INFORMATION SAFE?</h3>
              ...
              <h3 id="priveryRights">11. WHAT ARE YOUR PRIVACY RIGHTS?</h3>
              <p>
                <strong>In Short:</strong> In some regions, such as the European
                Economic Area (EEA), United Kingdom (UK), and Switzerland, you
              ...
              <p>
                ...
                may email us at contact@verge.app.
              </p>

              <h3 id="feature_control">
              ...
              <h3 id="updateNotice">13. DO WE MAKE UPDATES TO THIS NOTICE?</h3>
              <p>
              ...
              <h3 id="contactUSNotice">
                14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?
              </h3>
              <p>
                If you have questions or comments about this notice, you may
                email us at contact@verge.app or contact us by post at: <br />
                VERGE TECHNOLOGIES SINGLE MEMBER P.C. <br />
                Stratigi 7, Neo Psichiko 154 51, Greece <br />
                Neo Psichiko 154 51 <br />
                Greece
              </p>
              <h3 id="reviewUpdate">
