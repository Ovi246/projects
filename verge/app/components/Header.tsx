    ...
    <nav className="navbar navbar-expand-lg">
      <div className="container-fluid">
        <Link className="navbar-brand" href="/">
          <Image src="/assets/icons/verge.svg"  alt="" className="img-fluid img_lg" layout='fill' objectFit='cover'/>
          <Image src="/assets/logo.png" alt=""  className="img-fluid img_sm" layout='fill' objectFit='cover'/>
        </Link>
        {/* <!-- responsive bars icon  --> */}
        <button className="navbar-toggler navbar_toggle_line" type="button" onClick={toggleMenu}>
          <span className="">
            <svg width="31" height="13" viewBox="0 0 31 13" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g id="Group 10467">
                <line id="Line 425" x1="0.4375" y1="1.07422" x2="30.4375" y2="1.07422" stroke="white"
                  stroke-width="2" />
                <line id="Line 426" x1="0.4375" y1="11.0781" x2="30.4375" y2="11.0781" stroke="white"
                  stroke-width="2" />
              </g>
            </svg>
          </span>
        ...
        {/* <!-- large screen menu start --> */}
        {
          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <Link className="nav-link" href="/" onClick={hideMenu}>Download</Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" href="#features_1" onClick={hideMenu}>Features</Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" href="#partners" onClick={hideMenu}>Our Partners</Link>
            </li>
        ...
        <div className="nav_CTA">
          {}
          <Link href="#" className="btn btn-custom" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop"
            onClick={hideMenu} style={{ backgroundColor: "#FFAB6F" }}>Contact</Link>
          <Link href="#" className="btn btn-custom-radial">For Venues</Link>
        </div> 
        {/* <!-- mobile screen CTA end --> */}
        {/* <!-- mobile screen CTA start --> */}
        <div className="nav_CTA mobile_M_CTA">
          <Link href="" className="btn btn-custom" onClick={hideMenu}>Venues</Link>
          <Link href="" className="btn btn-custom-radial" onClick={hideMenu}>Download</Link>
        </div> 
        {/* <!-- mobile screen CTA end --> */}
        ...
        <div className={`mobile_menu ${isMenuVisible ? 'show' : ' '}`}>
          ...
          <div className="cross_icon" >
            <button className="bg-transparent navbar_toggle_cross" onClick={hideMenu}>
              <svg xmlns="http://www.w3.org/2000/svg" width="87" height="86" viewBox="0 0 87 86" fill="#1E1432;">
                <line x1="65.2364" y1="22.181" x2="22.458" y2="64.9593" stroke="white" />
                <line x1="64.5361" y1="64.9627" x2="21.7578" y2="22.1844" stroke="white" />
              </svg>
            </button>
          </div>
          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <Link className="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop"
                onClick={hideMenu}>Contact US</Link>
            </li>
          ...
          <div className="f_btm_left">
            ...
            <p className="menu_copyright">©2023 Verge, All rights reserved</p>
          </div>
      ...
      <div>
        ...
        <div className="images">
          <div className="hero_shape_shadow">
            <Image src="/assets/shape.png" className="" alt="" layout='fill' objectFit='cover'/>
          </div>
         <Image src="/assets/_shape.png" className="hero_shape_shadow_sm" alt="" layout='fill' objectFit='cover'/> 

          <div className="right_images">
            <Image src="/assets/hero_b.png" className=" img-fluid" alt="" layout='fill' objectFit='cover'/>
          </div>
          <div className="left_images">
            <Image src="/assets/hero_a.png" className=" img-fluid " alt="" layout='fill' objectFit='cover'/>
          </div>
        </div>
