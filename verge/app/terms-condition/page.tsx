...
const terms = () => {
  return (
    <main>
      <section id="terms_wrapp">
        <div className="papers_container">
          <div className="paperwrap">
            <h2>Terms & Conditions</h2>
            <div className="content_boX">
              <p className="update_text">Last updated October 10, 2023 </p>
              <p>
                AGREEMENT TO OUR LEGAL TERMS We are VERGE TECHNOLOGIES SINGLE
                MEMBER P.C., doing business as Verge Tech &apos;
                <strong>Company</strong>&apos;, &apos;we<strong>us</strong>
                &apos;, or &apos;<strong>our</strong>&apos;). Our VAT number is
                EL802223266.
              </p>

              <p>
                We operate the website https://www.verge.app (the &apos;
                <strong>Site</strong>&apos;), the mobile application Verge (the
              ...
              <p>
                Verge is an application that allows users to connect with those
                around them at bars, clubs and events. Users are also able to
                see the event calendars of participating venues and gain access
                to exclusive promotions. You can contact us by phone at
                (+30)2102844729, email at contact@verge.app, or by mail to
                Stratigi 7, Neo Psichiko 154 51, Greece, Neo Psichiko 154 51,
                Greece.
              </p>
              <p>
                These Legal Terms constitute a legally binding agreement made
                between you, whether personally or on behalf of an entity
                (&apos;you&apos;), and VERGE TECHNOLOGIES SINGLE MEMBER P.C.,
            ...
            <div className="rules">
              ...
              <ol>
                ...
                <li>
                  <a href="#property">INTELLECTUAL PROPERTY RIGHTS</a>
                </li>
                <li>
                ...
                <li>
                  <a href="#payments">PURCHASES AND PAYMENT</a>
                </li>
                <li>
                  <a href="#cancellationv">CANCELLATION </a>
                </li>
                <li>
                  <a href="#softwere">SOFTWARE </a>
                </li>
                <li>
                  <a href="#activites">PROHIBITED ACTIVITIES</a>
                </li>
                <li>
                  <a href="#contributions">USER GENERATED CONTRIBUTIONS</a>
                </li>
                <li>
                  <a
                    href="#c_licence
                ...
                <li>
                  <a href="#mobile_app_l">MOBILE APPLICATION LICENCE</a>
                </li>
                <li>
                  <a href="#social_media">SOCIAL MEDIA</a>
                </li>
                <li>
                  <a href="#third_party">THIRD-PARTY WEBSITES AND CONTENT</a>
                </li>
                <li>
                  <a href="#advertise">ADVERTISERS </a>
                </li>
                <li>
                  <a href="#service_management">SERVICES MANAGEMENT</a>
                </li>
                <li>
                  <a href="#privecy_policy">PRIVACY POLICY</a>
                </li>
                <li>
                  <a href="#copyright_inter">COPYRIGHT INFRINGEMENTS</a>
                </li>
                <li>
                  <a href="#terms_termination">TERM AND TERMINATION</a>
                </li>
                <li>
                ...
                <li>
                  <a href="#correction">CORRECTIONS </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#indemn">INDEMNIFICATION </a>
                </li>
                <li>
                  <a href="#user_data">USER DATA</a>
                </li>
                <li>
                  <a href="#electronic_media">
                    ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
                  </a>
                </li>
                <li>
                  <a href="#miscellaneos">MISCELLANEOUS </a>
                </li>
                <li>
              ...
              <h3 id="property">2. INTELLECTUAL PROPERTY RIGHTS</h3>
              <h6>Our intellectual property</h6>
              <p>There is certain content we can&apos;t allow on Verge</p>
              <p>
              ...
              <p>
                ...
                <a href="">&apos;PROHIBITED ACTIVITIES&apos;</a> section below,
              ...
              <p>
                ...
                Terms, please address your request to: contact@verge.app. If we
              ...
              <p>
                ...
                <a href="">&apos;PROHIBITED ACTIVITIES&apos;</a> section
              ...
              <p>
                ...
                <a href="">&apos;COPYRIGHT INFRINGEMENTS&apos;</a> section
                below.
              </p>
              ...
              <h3 id="payments">5. PURCHASES AND PAYMENT</h3>
              ...
              <p>
                ...
                contact@verge.app or call us at (+30)2102844729.
              </p>
              <h3 id="softwere">7. SOFTWARE</h3>
              <p>
                We may include software for use in connection with our Services.
                If such software is accompanied by an end user licence agreement
                ...
                non-transferable licence to use such software solely in
              ...
              <h3 id="activites">8. PROHIBITED ACTIVITIES</h3>
              <p>
              ...
              <h3 id="contributions">9. USER GENERATED CONTRIBUTIONS</h3>
              <span>
                {" "}
              ...
              <ul>
                ...
                <li>
                  ...
                  each and every identifiable inSectionidual person in your
                  Contributions to use the name or likeness of each and every
                  such identifiable inSectionidual person to enable inclusion
              ...
              <h3 id="c_licence">10. CONTRIBUTION LICENCE</h3>
              <p>
              ...
              <h3 id="mobile_app_l">11. MOBILE APPLICATION LICENCE</h3>
              <h6>Use Licence</h6>
              <p>
              ...
              <p>
                ...
                Distributor&apos;) to access the Services: (1) the licence
                granted to you for our App is limited to a non-transferable
                licence to use the application on a device that utilises the
              ...
              <h3 id="social_media">12. SOCIAL MEDIA</h3>
              <p>
              ...
              <h3 id="third_party">13. THIRD-PARTY WEBSITES AND CONTENT</h3>
              <p>
              ...
              <h3 id="advertise">14. ADVERTISERS</h3>
              <p>
              ...
              <h3 id="service_management">15. SERVICES MANAGEMENT</h3>
              <p>
              ...
              <h3 id="privecy_policy">16. PRIVACY POLICY</h3>
              <p>
                We care about data privacy and security. Please review our
                Privacy Policy. By using the Services, you agree to be bound by
                our <a href="privacy-ploicy.html">Privacy Policy</a>, which is
                incorporated into these Legal Terms. Please be advised the
                Services are hosted in Greece. If you access the Services from
                any other region of the world with laws or other requirements
                governing personal data collection, use, or disclosure that
                differ from applicable laws in Greece, then through your
                continued use of the Services, you are transferring your data to
                Greece, and you expressly consent to have your data transferred
                to and processed in Greece.
              </p>
              <h6 id="copyright_inter">17. COPYRIGHT INFRINGEMENTS</h6>
              <p>
                We respect the intellectual property rights of others. If you
                believe that any material available on or through the Services
                infringes upon any copyright you own or control, please
              ...
              <h3 id="terms_termination">18. TERM AND TERMINATION</h3>
              <p>
              ...
              <h3 id="modification">19. MODIFICATIONS AND INTERRUPTIONS</h3>
              <p>
              ...
              <p>
                ...
                country to residence. VERGE TECHNOLOGIES SINGLE MEMBER P.C. and
                yourself both agree to submit to the non-exclusive jurisdiction
                of the courts of London, which means that you may make a claim
                to defend your consumer protection rights in regards to these
                Legal Terms in the United Kingdom, or in the EU country in which
                you reside.
              </p>
              ...
              <h3 className="correction">22. CORRECTIONS</h3>
              <p>
              ...
              <h3 id="indemn">25. INDEMNIFICATION</h3>
              <p>
              ...
              <h3 id="user_data">26. USER DATA</h3>
              <p>
              ...
              <h3 id="miscellaneos">28. MISCELLANEOUS</h3>
              <p>
              ...
              <h3 id="contact_us">29. CONTACT US</h3>
              <p>
              ...
              <p>
                VERGE TECHNOLOGIES SINGLE MEMBER P.C. <br />
                Stratigi 7, Neo Psichiko 154 51, Greece Neo Psichiko 154 51
                Greece <br />
                Phone: (+30)2102844729 <br />
                contact@verge.app
              </p>
            </div>
          </div>
